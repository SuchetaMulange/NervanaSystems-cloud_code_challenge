...
def get_command_output():
    ...
    command_output={};
    cursor=conn.execute("SELECT * from COMMANDS where Command=commands;");
    for row in cursor:
    	command_output['COMMAND']=row[0];
    	command_output['COMMAND_LENGTH']=row[1];
    	command_output['TIME_TO_COMPLETE']=row[2];
    	command_output['COMMAND_OUTPUT']=row[3];
